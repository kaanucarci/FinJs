    ...
    <>
      <div className="max-w-7xl mx-auto lg:p-6 p-2 flex flex-row justify-center items-center gap-5">
        <div className="w-full shadow-modern-lg bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50">
          <div className="grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 grid xl:gap-0 gap-6 p-6">
            ...
            <div className="flex gap-3 justify-start items-center">
              <button
                className="border xl:min-w-[120px] max-h-[44px] hover:bg-slate-50 hover:border-slate-300 transition-all duration-300 border-slate-200 text-slate-700 py-2 px-4 gap-2 flex items-center text-sm justify-center rounded-xl shadow-sm hover:shadow-md font-medium"
      ...
      <EditBudget
        ...
        onSuccess={(updated) => {
          ...
          const isValid = keys.every((k) => allowedKeys.includes(k));
