    ...
    return (
      ...
      >
        <div className="max-w-4xl mx-auto p-6 flex flex-col lg:flex-row justify-center align-center gap-5 lg-hidden">
          ...
          <div className="mb-1">
            <label htmlFor="endDate" className="block text-xs font-light text-gray-700">
              Bitiş Tarihi
            </label>
            <input
              type="date"
          ...
          <div className="mb-1">
            <label htmlFor="min" className="block text-xs font-light text-gray-700">
              Minimum Tutar
            </label>
            <input
              type="number"
          ...
          <div className="mb-1">
            <label htmlFor="max" className="block text-xs font-light text-gray-700">
              Maksimum Tutar
            </label>
            <input
              type="number"
          ...
          <div className="mb-1">
            <label htmlFor="year" className="block text-xs font-light text-gray-700">
              Bütçe Yılı
            </label>
