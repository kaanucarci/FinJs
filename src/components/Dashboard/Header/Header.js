            ...
            <ul className="p-1">
              <li>
                <button
                  ...
                  onClick={() => logout()}
                >
                  <svg className="_o2IXcpM0qnG3JPReKus E9GV5sZJIbfO_GEQ_moc" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="20"height="20">
                      <path stroke="#E02424" strokeLinecap="round"  strokeWidth={2} d="M20 12H8m12 0-4 4m4-4-4-4M9 4H7a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h2"></path>
                  </svg>  
                  Çıkış Yap
                </button>
              </li>
